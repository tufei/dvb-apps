                         ...
                         struct dvbcfg_multiplex* multiplex)
{
        ...
        case DVBCFG_SOURCETYPE_DVBS:
                switch(multiplex->delivery.dvb.polarization) {
                ...
                if (fbackend->long_delivery) {
                        fprintf(fbackend->outhandle, "%i %s %c %i %s\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.inversion,
                                                     inversion_list),
                                polarization,
                                multiplex->delivery.dvb.fe_params.u.qpsk.symbol_rate,
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.qpsk.fec_inner,
                                                     fec_list));
                } else {
                        fprintf(fbackend->outhandle, "%i %i %c %i %i\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                multiplex->delivery.dvb.fe_params.inversion,
                                polarization,
                                multiplex->delivery.dvb.fe_params.u.qpsk.symbol_rate,
                                multiplex->delivery.dvb.fe_params.u.qpsk.fec_inner);
                }
                break;

        case DVBCFG_SOURCETYPE_DVBC:
                if (fbackend->long_delivery) {
                        fprintf(fbackend->outhandle, "%i %s %i %s %s\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.inversion,
                                                     inversion_list),
                                multiplex->delivery.dvb.fe_params.u.qpsk.symbol_rate,
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.qam.fec_inner,
                                                     fec_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.qam.modulation,
                                                     qam_modulation_list));
                } else {
                        fprintf(fbackend->outhandle, "%i %i %i %i %i\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                multiplex->delivery.dvb.fe_params.inversion,
                                multiplex->delivery.dvb.fe_params.u.qpsk.symbol_rate,
                                multiplex->delivery.dvb.fe_params.u.qam.fec_inner,
                                multiplex->delivery.dvb.fe_params.u.qam.modulation);
                }
                break;

        case DVBCFG_SOURCETYPE_DVBT:
                if (fbackend->long_delivery) {
                        fprintf(fbackend->outhandle, "%i %s %s %s %s %s %s %s %s\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.inversion,
                                                    inversion_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.ofdm.bandwidth,
                                                    bandwidth_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.ofdm.code_rate_HP,
                                                    fec_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.ofdm.code_rate_LP,
                                                    fec_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.ofdm.constellation,
                                                    constellation_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.ofdm.transmission_mode,
                                                    transmission_mode_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.ofdm.guard_interval,
                                                    guard_interval_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.ofdm.hierarchy_information,
                                                    hierarchy_information_list));
                } else {
                        fprintf(fbackend->outhandle, "%i %i %i %i %i %i %i %i %i\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                multiplex->delivery.dvb.fe_params.inversion,
                                multiplex->delivery.dvb.fe_params.u.ofdm.bandwidth,
                                multiplex->delivery.dvb.fe_params.u.ofdm.code_rate_HP,
                                multiplex->delivery.dvb.fe_params.u.ofdm.code_rate_LP,
                                multiplex->delivery.dvb.fe_params.u.ofdm.constellation,
                                multiplex->delivery.dvb.fe_params.u.ofdm.transmission_mode,
                                multiplex->delivery.dvb.fe_params.u.ofdm.guard_interval,
                                multiplex->delivery.dvb.fe_params.u.ofdm.hierarchy_information);
                }
                break;

        case DVBCFG_SOURCETYPE_ATSC:
                if (fbackend->long_delivery) {
                        fprintf(fbackend->outhandle, "%i %s %s\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.inversion,
                                                     inversion_list),
                                dvbcfg_lookupsetting(multiplex->delivery.dvb.fe_params.u.vsb.modulation,
                                                     atsc_modulation_list));
                } else {
                        fprintf(fbackend->outhandle, "%i %i %i\n",
                                multiplex->delivery.dvb.fe_params.frequency,
                                multiplex->delivery.dvb.fe_params.inversion,
                                multiplex->delivery.dvb.fe_params.u.vsb.modulation);
                }
                break;
        }
        fprintf(fbackend->outhandle, "\n");
