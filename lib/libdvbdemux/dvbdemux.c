				...
				int start, int checkcrc)
{
	...
	/* I have decided to hide a lot of the complexity here. You can have
	 * up to 16 different table filters per demux fd, each with their own
	 * table/tablemask combo. Additionally, the bits in the 'filter.mode'
	 * field are used to specify which bits in a sectionid MUST match those
	 * in table (mode bit = 0), and which bits MUST NOT match (mode bit = 1).
	 */
