...
void en50221_app_ai_register_callback(struct en50221_app_ai *ai, en50221_app_ai_callback callback, void *arg)
{
...
int en50221_app_ai_enquiry(struct en50221_app_ai *ai, uint16_t session_number)
{
	uint8_t data[4];
...
int en50221_app_ai_entermenu(struct en50221_app_ai *ai, uint16_t session_number)
{
	uint8_t data[4];
			   ...
			   uint8_t *data, uint32_t data_length)
{
	...
	switch(tag) {
	case TAG_APP_INFO:
		return en50221_app_ai_parse_app_info(ai, slot_id, session_number, data+3, data_length-3);
	}
