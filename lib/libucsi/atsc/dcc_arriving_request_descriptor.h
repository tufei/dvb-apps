...
{
	struct atsc_text *txt = ((uint8_t*) d) + sizeof(struct atsc_dcc_departing_request_descriptor);

	if (atsc_text_validate((uint8_t*) txt, d->dcc_departing_request_text_length))
		return NULL;
